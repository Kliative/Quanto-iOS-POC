...
protocol testBaseDataSentDelegate {
    func userDidEnterTestBaseData(data: CountryData)
}


class TestBaseVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    var delegate: testBaseDataSentDelegate? = nil
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.userDidEnterTestBaseData(data: countryData)
